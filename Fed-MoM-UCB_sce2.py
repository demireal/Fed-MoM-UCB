...
K = len(mu_global)
lam = 0.2  # Byzantine fraction (can change to 0.25)
epsilon = 0.05 
global T
T = int(1e5)
N = 100  # repeat times
...
np.save('./np_arrays/mean_fmomucb_sce_{}_regret_sp10p_map_{}_lam_{}.npy'.format(scenario, map_type, lam), np.mean(regret, axis=0))
np.save('./np_arrays/std_fmomucb_sce_{}_regret_sp10p_map_{}_lam_{}.npy'.format(scenario, map_type, lam), np.std(regret, axis=0))
np.save('./np_arrays/mean_fmomucb_sce_{}_comm_regret_sp10p_map_{}_lam_{}.npy'.format(scenario, map_type, lam), np.mean(comm_regret, axis=0))
np.save('./np_arrays/std_fmomucb_sce_{}_comm_regret_sp10p_map_{}_lam_{}.npy'.format(scenario, map_type, lam), np.std(comm_regret, axis=0))
np.save('./np_arrays/mean_fmomucb_sce_{}_nocomm_regret_sp10p_map_{}_lam_{}.npy'.format(scenario, map_type, lam), np.mean(no_comm_reg, axis=0))
np.save('./np_arrays/std_fmomucb_sce_{}_nocomm_regret_sp10p_map_{}_lam_{}.npy'.format(scenario, map_type, lam), np.std(no_comm_reg, axis=0))
